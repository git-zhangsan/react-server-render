...
_reactDom2.default.render(_react2.default.createElement(_Home2.default, null), document.getElementById('root')); /*
                                                                                                                  * @Author: zhanghuiming
                                                                                                                  * @Date:   2017-09-05 08:05:49
                                                                                                                  * @Last Modified by:   zhanghuiming
                                                                                                                  * @Last Modified time: 2017-09-05 15:10:25
                                                                                                                  */
...
var Home = function (_React$Component) {
	...
	function Home(props) {
		...
		_this.clickToChangeColor = _this.clickToChangeColor.bind(_this);
		_this.state = {
			color: '#000'
		};
		return _this;
	...
	_createClass(Home, [{
		key: 'clickToChangeColor',
		value: function clickToChangeColor(e) {
			this.setState({
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ onClick: this.clickToChangeColor, style: { color: this.state.color } },
				'hello from \u5F20\u4E09\u3002'
			);
		}
	}]);
